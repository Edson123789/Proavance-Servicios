...
{
    [Route("api/OcurrenciaAlterno")]
    public class OcurrenciaAlternoController : BaseController<TOcurrenciaAlterno, ValidadorOcurrenciaAlternoDTO>
    {
        public OcurrenciaAlternoController(IIntegraRepository<TOcurrenciaAlterno> repositorio, ILogger<BaseController<TOcurrenciaAlterno, ValidadorOcurrenciaAlternoDTO>> logger, IIntegraRepository<Persistencia.Models.TLog> repositoriologg) : base(repositorio, logger, repositoriologg)
        {
        }
        ...
        public ActionResult ObtenerConfigLlamadaPorIdOcurrencia(int IdOcurrencia)
        {
            try
            {
                ConfiguracionLlamadaOcurrenciaAlternoRepositorio repositorio = new ConfiguracionLlamadaOcurrenciaAlternoRepositorio();
        ...
        public ActionResult ObtenerActividadesCabeceras()
        {
            try
            {
                ...
                var lista = repositorio.ObtenerTodoFiltroAlterno();
                return Json(new { Result = "OK", Records = lista });
        ...
        public ActionResult ObtenerListaOcurrencias()
        {
            try
            {
                OcurrenciaAlternoRepositorio repositorio = new OcurrenciaAlternoRepositorio();
        ...
        public ActionResult ObtenerActividadesPorOcurrencia(int IdOCurrencia)
        {
            try
            {
                OcurrenciaAlternoRepositorio _repOcurrencia = new OcurrenciaAlternoRepositorio();
        ...
        [Route("[action]/{Id}")]
        [HttpGet]
        public ActionResult ObtenerCategoriasPorId(int Id)
        {
            IList<OcurrenciaPorActividadPadreDTO> lista = new List<OcurrenciaPorActividadPadreDTO>();
            OcurrenciaAlternoRepositorio repositorio = new OcurrenciaAlternoRepositorio();
            ...
            try
            {
                lista = repositorio.ObtenerOcurrenciasActividadPorId(Id);
                //return Ok(lista);
                return Json(new { Result = "OK", Records = lista });
            }
            catch (Exception ex)
        ...
        public ActionResult ObtenerConfiguracionLLamadasPorOcurrencia(int IdOcurrencia)
        {
            try
            {
                ConfiguracionLlamadaOcurrenciaAlternoRepositorio _repConfiguracionLlamada = new ConfiguracionLlamadaOcurrenciaAlternoRepositorio();
        ...
        public ActionResult ActualizarOcurrencia([FromBody] OcurrenciaCompuestoDTO Objeto)
        {
            try
            {
                ...
                OcurrenciaAlternoRepositorio _repOcurrencia = new OcurrenciaAlternoRepositorio();
                OcurrenciaReporteAlternoRepositorio _repOcurrenciaReporte = new OcurrenciaReporteAlternoRepositorio();
                OcurrenciaActividadRepositorio _repOcurrenciaActividad = new OcurrenciaActividadRepositorio();

                OcurrenciaAlternoBO ocurrencia = new OcurrenciaAlternoBO();
                ...
                ocurrencia.IdTipoOcurrencia = Objeto.ocurrencia.IdTipoOcurrencia;
                ...
                {
                    OcurrenciaReporteAlternoBO ocurrenciaReporte = new OcurrenciaReporteAlternoBO();
                ...
                else
                {
                    ...
                    for (int i = 0; i < configuracionesDesdeCliente.Count; ++i)
                    {
                        if (configuracionesDesdeCliente[i].Id == 0) // cuando son configuraciones nuevas (insercion)
                        {
                            ...
                            ConfiguracionLlamadaOcurrenciaAlternoBO NuevaConfiguracionLlamada = new ConfiguracionLlamadaOcurrenciaAlternoBO();
        ...
        public ActionResult InsertarOcurrencia([FromBody] OcurrenciaCompuestoDTO Objeto)
        {
            ...
            {
                integraDBContext contexto = new integraDBContext();
                OcurrenciaReporteAlternoRepositorio _repOcurrenciaReporte = new OcurrenciaReporteAlternoRepositorio(contexto);
                ...
                ocurrencia.IdTipoOcurrencia = newOcurrencia.IdTipoOcurrencia;
                if (!ocurrencia.HasErrors)
                ...
                ConfiguracionLlamadaOcurrenciaAlternoRepositorio _repoConfLlamada = new ConfiguracionLlamadaOcurrenciaAlternoRepositorio();
                var configuracionesDesdeCliente = Objeto.configuraciones;
                for (int i = 0; i < configuracionesDesdeCliente.Count; ++i)
                {
        ...
        public ActionResult ObtenerCombosOcurrencia()
        {
            ...
            try
            {
                ...
                var actividadCabecera = _repActividadCabecera.ObtenerTodoFiltroAlterno();
        ...
        [Route("[Action]")]
        [HttpGet]
        public ActionResult ObtenerAreaOcurrencia()
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            try
            {
                PersonalAreaTrabajoRepositorio _repPersonalAreaTrabajo = new PersonalAreaTrabajoRepositorio();
                var personalAreaTrabajo = _repPersonalAreaTrabajo.ObtenerAreaTrabajoPersonalNombre();
                return Ok(new { Area = personalAreaTrabajo});
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
    ...
    public class ValidadorOcurrenciaAlternoDTO : AbstractValidator<TOcurrenciaAlterno>
    {
        public static ValidadorOcurrenciaAlternoDTO Current = new ValidadorOcurrenciaAlternoDTO();
        public ValidadorOcurrenciaAlternoDTO()
        {
