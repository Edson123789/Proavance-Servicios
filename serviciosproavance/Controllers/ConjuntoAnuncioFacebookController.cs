...
namespace serviciosproavance.Controllers
{
    ...
    {
        public ConjuntoAnuncioFacebookController(IIntegraRepository<TConjuntoAnuncioFacebook> repositorio, ILogger<BaseController<TConjuntoAnuncioFacebook, ValidadorConjuntoAnuncioFacebookDTO>> logger, IIntegraRepository<BSI.Integra.Persistencia.Models.TLog> repositoriologg) : base(repositorio, logger, repositoriologg)
        {
        }
