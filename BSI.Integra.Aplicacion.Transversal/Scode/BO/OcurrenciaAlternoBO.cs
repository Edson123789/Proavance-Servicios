...
{
    public class OcurrenciaAlternoBO : BaseBO
    {
        ...
        private OcurrenciaAlternoRepositorio _repOcurrencia;

        public OcurrenciaAlternoBO()
        {
            ActualesErrores = new Dictionary<string, List<ErrorInfo>>();
        }

        public OcurrenciaAlternoBO(int id)
        {
            _repOcurrencia = new OcurrenciaAlternoRepositorio();
            ...
            this.IdTipoOcurrencia = Ocurrencia.IdTipoOcurrencia;
