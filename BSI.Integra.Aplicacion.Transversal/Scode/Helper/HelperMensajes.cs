...
namespace BSI.Integra.Aplicacion.Transversal.Helper
{
    ...
    {
        public string mensaje_email_proceso_pago_peru(string email, string password, string url, AlumnoBO contacto, List<MontoPagoCronogramaDetalleBO> listaCronogama, string pgeneral, string CodigoMatricula, string Pais, string simboloMoneda)
        {
        ...
        public string mensaje_email_finanzas(AlumnoBO contacto, List<MontoPagoCronogramaDetalleBO> listaCronogama, string CodigoMatricula, string simboloMoneda, CentroCostoBO centroCosto)
        {
