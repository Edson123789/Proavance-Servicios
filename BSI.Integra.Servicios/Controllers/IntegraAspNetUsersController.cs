...
namespace BSI.Integra.Servicios.Controllers
{
    ...
    {
        public IntegraAspNetUsersController(IIntegraRepository<TIntegraAspNetUsers> repositorio, ILogger<BaseController<TIntegraAspNetUsers, ValidadorIntegraAspNetUsersDTO>> logger, IIntegraRepository<Persistencia.Models.TLog> repositoriologg) : base(repositorio, logger, repositoriologg)
        {
        }
