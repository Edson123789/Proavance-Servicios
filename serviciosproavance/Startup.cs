...
using serviciosproavance.Helpers;
...
using serviciosproavance.GlobalErrorHandling.CustomExceptionMiddleware;
using Elastic.Apm.NetCoreAll;
using Microsoft.AspNetCore.Http.Features;

namespace serviciosproavance
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c => {
                c.SwaggerDoc("v1", new Info { Title = "Integra V4.0 API", Version = "v1" });
